...
def generate_schedule_json(user_id):
    ...
    class Exercise(Base):
        ...
        bodypart_id = Column(
            Integer, ForeignKey("body_parts.bodypart_id"), nullable=False
        )
        exercise_type_id = Column(
            Integer, ForeignKey("exercise_type.exercise_type_id"), nullable=False
        )
        equipment_id = Column(
            String, ForeignKey("equipment.equipment_name"), nullable=False
        )
        difficulty_id = Column(
            String, ForeignKey("difficulty.difficulty_name"), nullable=False
        )
    ...
    class WorkoutExercise(Base):
        ...
        exercise_id = Column(
            Integer, ForeignKey("exercise.exercise_id"), nullable=False
        )
