...
from healthfirstai_prototype.models.data_models import Food, NutritionVector
...
# TODO: Lawrence complete this
# As a part of this, give the agent more information about the user such as calorie, macro, and long term goals
def register_new_user(user_credentials: str):
    """
    Register a new user with the given credentials

    Args:
        JSON object with the user credentials

    Returns:
        The user's ID indicating that they have been successfully registered
    """

    # Given their weight, age, goal, calculate the number of calories they should eat per day
    # and the macronutrient breakdown of it
